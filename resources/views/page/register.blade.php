    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form class="login mt-0" action="{{ route('register_handling') }}" method="post">
                    @csrf
                    @method('POST')
                ...
                <div class="social-login">
                    <h3 style="margin-top: 50px !important;">Sign Up</h3>
                    <h3 style="font-size: 13px;">You have account ? <a href="{{ route('login') }}">Login</a></h3>
